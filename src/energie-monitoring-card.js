customElements.define('strom-monitoring-card', class extends HTMLElement {
  constructor() {
    super();
...
window.customCards.push({
  type: 'strom-monitoring-card',
  name: 'Strom Monitoring Card',
  description: 'Soll/Ist Netzverbrauch + BKW Amortisation via Selbstverbrauch'
});
